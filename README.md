...
| **4. 金融・マクロ構造** | 💹 「CBDC 3.0」で通貨量をスマート合意で動的制御<br>💹 ベーシックインカムを月額20万円分支給 |
...
### 背景：産業爆発の不可避性と即時支給の妥当性

* **産業爆発（Industrial Take‑Off）**: AGI による指数的生産性向上と LENR によるエネルギー限界費用ゼロ化の組み合わせは、2030 年代前半までに名目 GDP を年倍増させる「超成長モード」を誘発すると予測される。
* **リードタイム問題**: 法整備・CBDC ウォレット展開・決済インフラ拡充には最低 2–3 年を要するため、今すぐ BI を制度化しておくことで産業爆発ピーク時の社会ショックを緩和できる。
* **財源の先取り**: 既に稼働中の AGI サービスおよび再エネ余剰電力取引から、初年度で約 40 兆円の成果税と LENR 配当を確保可能（2026 年予測）。これにより月 20 万円 BI の約 1/3 を賄い、残額は CBDC シニョリッジと赤字国債で短期的にブリッジする。
* **経済加速の触媒**: 家計可処分所得の即時拡大は需要側の加速器となり、AI・ロボット・LENR 設備への民間投資リスクを大幅に低減し、指数カーブを前倒しにする。

> **提言**: 星間加速党は産業爆発を前提とした **「先取り型ベーシックインカム（20 万円/月）」を 2026 年度から開始** することを目指す。

| 項目  | 数値                                               | 備考                   |
| --- | ------------------------------------------------ | -------------------- |
| 支給額 | **月 20 万円/人**                                    | 年間 240 万円、世帯上限なし     |
| 対象  | 日本国籍・長期在留者                                       | 出生即加入、国外居住 1 年超は一時停止 |
| 財源  | ① AGI 成果税 ② Sovereign LENR Fund 配当 ③ CBDC シニョリッジ | 詳細は財政政策ブループリント参照     |
| 実装  | CBDC ウォレットに自動入金、スマートコントラクトで相続・移転制御               |                      |

> **可変式**: GDP 伸び率が 2 % 未満の場合、BI は (20 万円 × 伸び率比) に自動スライド。
...
## Ⅵ. 国際連携方針（International Cooperation Policy）
